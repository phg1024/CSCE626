/*
 *  preifxsum_openmp.cpp - Demonstrates parallelism via random fill and prefix
 *  sum routines.
 ...
 *
 *  NOTE: steps 2-4 are repeated as many times as requested (numiterations)
 *---------------------------------------------------------*/
